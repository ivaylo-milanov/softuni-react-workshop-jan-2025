export default function CreateEditForm({
    ...
    return (
        <div class="overlay">
            <div class="backdrop" onClick={onCloseCreate}></div>
            <div class="modal">
                <div class="user-container">
                    <header class="headers">
                        <h2>Edit User/Add User</h2>
                        <button class="btn close" onClick={onCloseCreate}>
                    ...
                    <form>
                        ...
                        <div id="form-actions">
                            ...
                            <button id="action-cancel" class="btn" type="button" onClick={onCloseCreate}>
                                Cancel
                            </button>
                        </div>
                    </form>
